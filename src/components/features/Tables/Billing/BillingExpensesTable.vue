...
import ConfirmModal from "../../Modals/Confirm/ConfirmModal.vue";
...
async function delete_expense() {
  const result = await billingStore.deleteExpense(delete_item.value);
  if (result) {
    isDeleteModal.value = false;
    billingStore.getDataBillingExpenses(1, 10);
    notif.success("Expense Deleted");
  }
}
</script>
...
<template>
  <div>
    <div class="table-page table-page--expense-billing">
          ...
          <div class="table-select-block__select">
            ...
            >
              <div
                ...
                :class="
                  activeCount && 'table-select-block__select-count--active'
                "
              ...
              <div
                ...
                :class="
                  activeCount && 'table-select-block__select-list--active'
                "
              >
                <div
                  ...
                  :class="
                    countItem === 10 &&
                    'table-select-block__select-item--hidden'
                  "
      ...
      <div class="table-page__desktop-table desktop-table">
        <div class="desktop-table__row desktop-table__row--thead">
          ...
          <div class="desktop-table__td">Sum</div>
          <div class="desktop-table__td">Quantity</div>
        ...
        >
          ...
          <div class="desktop-table__td">
            <div class="button button--delete">
              <button v-on:click="set_delete_item(item.id)">Delete</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div v-for="item in dataBilling" :key="item.id" class="table-card">
            <div class="table-card__body">
              ...
              <div class="table-card__item">
                ...
                <div class="table-card__item-value">
                  <div class="button button--delete">
                    <button v-on:click="set_delete_item(item.id)">
                      Delete
                    </button>
                  </div>
                </div>
    ...
    <div>
      <SModal title="Are you sure?" v-if="isDeleteModal">
        <ConfirmModal
          @delete-offer="delete_expense"
          @set-visible="set_delete_item"
        />
      </SModal>
    </div>
  </div>

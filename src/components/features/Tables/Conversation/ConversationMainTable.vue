...
import { getDataTableAdmin } from "./hard_code_data";
...
if (filter.period_filter && filter.period_router !== "conversation") {
  filter.period_filter = false;
  filter.period_router = null;
...
<template>
  <div class="table-page table-page--main-conversation">

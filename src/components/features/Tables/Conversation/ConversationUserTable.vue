...
conversationStore.getConversation(1, 10);
...
const getDataTable = computed(() => {
  return conversationStore.conversation.rows;
});

const dataTable = reactive(getDataTable);

const getAppPage = computed(() => {
  return conversationStore.conversation.max_page;
});
...
<template>
  <div class="table-page table-page--user-conversation">
    ...
    <div class="table-page__desktop-table desktop-table">
      ...
      >
        ...
        <div class="desktop-table__td">
          {{ useNan(((100 * item.approve) / item.count).toFixed()) }} %
        </div>
        <div class="desktop-table__td">
          {{
            useNan(((100 * item.approve) / (item.count - item.trash)).toFixed())
          }}
          %
        </div>
        <div class="desktop-table__td">{{ item.canceled }}</div>
        <div class="desktop-table__td">
          {{ useNan(((100 * item.canceled) / item.count).toFixed()) }} %
        </div>

        <div class="desktop-table__td">
          {{
            useNan(
              ((100 * item.canceled) / (item.count - item.trash)).toFixed()
            )
          }}
          %
        </div>
          ...
          <div class="table-card__body">
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span
                  >{{
                    (item.buyout / (item.approve - item.rejected_vx)) * 100
                  }}
                  %</span
                >
              </div>
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span>{{ (100 * item.approve) / item.count }} %</span>
              </div>
            </div>
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span
                  >{{
                    (100 * item.approve) / (item.count - item.trash)
                  }}
                  %</span
                >
              </div>
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span>{{ (100 * item.canceled) / item.count }} %</span>
              </div>
            </div>
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span
                  >{{
                    (100 * item.canceled) / (item.count - item.trash)
                  }}
                  %</span
                >
              </div>
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span>{{ (100 * item.hold) / item.count }} %</span>
              </div>
            </div>
            ...
            <div class="table-card__item">
              ...
              <div class="table-card__item-value">
                <span>{{ (100 * item.trash) / item.count }} %</span>
              </div>
            </div>
            <div class="table-card__item">
              <div class="table-card__item-label">

...
if (incomeStore.activeFilter) incomeStore.showcase.activeFilter = false;

const getDataTable = computed(() => {
  return incomeStore.showcase.rows;
});

const dataTable = reactive(getDataTable);

const getAppPage = computed(() => {
  return incomeStore.showcase.max_page;
});
...
watch(allPages, () => {
  // if (incomeStore.showcase.activeFilter) {
  //   incomeStore.showcase.setFilter(
  //     selectPage.value,
  //     countItem.value,
  //     filter.dataFilter
  //   );
  // } else {
  incomeStore.getShowcase(selectPage.value, countItem.value);
  //}
  const tmp = [];
...
watch(countItem, () => {
  // if (incomeStore.showcase.activeFilter) {
  //   incomeStore.showcase.setFilter(selectPage.value, countItem.value, filter.dataFilter);
  // } else {
  incomeStore.getShowcase(selectPage.value, countItem.value);
  // }
});
